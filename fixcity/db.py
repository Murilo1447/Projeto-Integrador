...
def ensure_schema_compatibility(db: DatabaseConnection):
    if db.backend == "sqlite":
        sqlite_migrations = {
            "usuarios": {
                ...
                "is_superuser": "ALTER TABLE usuarios ADD COLUMN is_superuser INTEGER NOT NULL DEFAULT 0",
    ...
    mysql_migrations = {
        "usuarios": {
            ...
            "is_superuser": "ALTER TABLE usuarios ADD COLUMN is_superuser TINYINT(1) NOT NULL DEFAULT 0",
